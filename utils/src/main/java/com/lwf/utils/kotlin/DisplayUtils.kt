 ...
 * @return Int
 */
fun Context.getDimenPx(@DimenRes resource: Int) = resources.getDimensionPixelSize(resource)
 ...
 * @return Int
 */
fun Context.getDimenDp(@DimenRes resource: Int) = px2dp(getDimenPx(resource).toFloat())
